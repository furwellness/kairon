...
class LLMFeaturizer(DenseFeaturizer, GraphComponent, ABC):
    ...
    def __init__(
        ...
        """
        super(LLMFeaturizer, self).__init__(execution_context.node_name, config)
    ...
    def load_api_key(self, bot_id: Text):
        if bot_id:
            ...
            raise KeyError(
                f"either set bot_id'in LLMFeaturizer config or set API_KEY in environment variables"
            )
    ...
    def get_default_config() -> Dict[Text, Any]:
        """Returns LLMFeaturizer's default config."""
        return {
    ...
    def get_tokens_embeddings(self, tokens):
        ...
        return self.get_embeddings(tokens_text)
    ...
    def _get_model_features_for_batch(
        ...
        sentence_embeddings.append(np.array(self.get_embeddings(sentence_text)))
